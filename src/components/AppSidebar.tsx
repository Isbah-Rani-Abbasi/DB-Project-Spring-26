...
import {
  ...
  Users, Library, BookMarked, LogOut, UserCog, Database, // Database icon import kiya
} from "lucide-react";
...
const adminItems: Item[] = [
  ...
  { title: "Master Records", url: "/admin/master-records", icon: Database }, // YAHAN URL THEEK KIYA HAI
];
                ...
                return (
                  <SidebarMenuItem key={item.url}>
                    <SidebarMenuButton asChild isActive={active} tooltip={item.title}>
                      <Link to={item.url as any}> {/* 'as any' laga diya TS error se bachne ke liye */}
